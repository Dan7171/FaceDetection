# code inspired from kaggle : https://www.kaggle.com/code/aliabdin1/calculate-mean-std-of-images

import numpy as np
import cv2
import os

# train_img_root = '/galitylab/students/Noam/Datasets/100_objects_00_each/train/'
# train_img_root = '/home/expertise/Dan/20%_faces_80%_hands_for_mean_std/'
# train_img_root = "/home/ssd_storage/datasets/students/expertise/Dan/Experiment_2_datasets/year_1_20_faces_80_hands_train_val_100_classes/"
# train_img_root = "/home/ssd_storage/datasets/students/expertise/Dan/Experiment_2_datasets/year_1_20_faces_80_hands_train_val_189_classes/train/"
...
def calc_avg_mean_std(folder_names, img_root, size):
    ...
    print(f'size = {size}')
    print(f'num of folders = {n_folders}')
